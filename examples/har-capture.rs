...
//     async fn capture_request(&self, _: &http::Request<Body>) -> RequestCapture {
...
// }
//
// fn copy_from_http_request_to_har(request: &http::Request<Body>) -> v1_2::Request {
...
// }
//
// fn copy_from_http_response_to_har(response: &http::Response<Body>) -> v1_2::Response {
//     let mut headers = Vec::new();
